...
export default {
  ...
  methods: {
    algorithm(){
      recommend({scoreAll: this.queryParams.scoreAll,
        scoreMath:this.queryParams.scoreMath,
        scoreEnglish:this.queryParams.scoreEnglish,
        scorePolitics:this.queryParams.scorePolitics,
        scoreMajor:this.queryParams.scoreMajor,
