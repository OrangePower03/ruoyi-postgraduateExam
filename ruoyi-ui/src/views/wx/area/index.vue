...
<script>
import { listArea, getArea, delArea, addArea, updateArea } from "@/api/wx/area";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('user/area/export', {
        ...this.queryParams
